...
variable "SecretsManagerRDSPostgreSQLRotationSingleUser_arn" {
  default = "arn:aws:lambda:us-east-1:268975820186:function:SecretsManagerRDSPostgreSQLRotationSingleUser"
}

variable "SecretsManagerRDSMySQLRotationSingleUser_arn" {
  default = "arn:aws:lambda:us-east-1:268975820186:function:SecretsManagerRDSMySQLRotationSingleUser"
}
